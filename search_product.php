                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavId">
                        ...
                        <form class="d-flex my-2 my-lg-0" method="get" >
                            ...
                            <input type="submit" class="btn btn-primary" value="search" name="search_data_product"></input>
      ...
      <div class="main">      
        <div class="row ">
            ...
            <ul class="navbar-nav me-auto text-center ">
                <li class="nav-item bg-info"><a class="nav-link text-light" href="#"><h4>Delivery brands</h4></a></li>
                <?php 
                    getbrands();                
                ?>
              ...
              <ul class="navbar-nav me-auto text-center ">
                <li class="nav-item bg-info"><a class="nav-link text-light" href="#"><h4>Categories</h4></a></li>
                <?php 
                getcategories();                
                ?>                
              </ul>
